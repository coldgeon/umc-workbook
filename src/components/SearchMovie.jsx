...
const MovieComponent = styled.div``; //key받기용
...
function SearchMovieList(movie_list) {
  ...
  // useEffect(() => {
  //   searchMovies(search_title).then((json) => setMovie(json.results));
  //   setLoading(false);
  // }, []);
  // useEffect(() => {
  //   setMovie(movie_list.movie_list);
  //   setLoading(false);
  // }, []);
  // console.log(movie)

  const movie = movie_list.movie_list;
